...
public class brdListAction implements Action {
	...
	public void paging() {
		try {
			...
			sb.append("<a href='/brd/brdList.action?currentPage=1'><img src='/img/button/btn_first.gif'/></a>&nbsp;&nbsp;&nbsp;");
			if (block > 1) {
				sb.append("<a href='/brd/brdList.action?currentPage="
						+ (startPage - 1)
			...
			for (int i = startPage; i <= endPage; i++) {
				if (currentPage == i) {
					...
					sb.append("<a href='/brd/brdList.action?currentPage=" + i
							+ "'>[" + i + "]</a>&nbsp;&nbsp;&nbsp;");
				}
			}
			sb.append("</span>");
			...
			sb.append("<a href='/brd/brdList.action?currentPage=" + totalPage
