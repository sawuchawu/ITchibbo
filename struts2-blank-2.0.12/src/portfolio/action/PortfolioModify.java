...
public class PortfolioModify implements Action, Preparable, ModelDriven<PortfolioBean> {
	...
	public String execute() throws Exception {
		...
		PortfolioDao.updatePortfolio(bean);
		System.out.println("ModifyAction Complete");
		
		return SUCCESS;
	}
	@Override
	public String toString() {
		return "PortfolioModify [job=" + job + ", bean=" + bean + "]";
	}
