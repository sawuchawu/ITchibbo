		...
		<div class="row">
														...
														<table width="100%" cellspacing="1" cellpadding="0" border="0">
															<tbody>
																...
																<tr>
																	...
																	<td style="padding: 7px 0" class="dotum11">
																		<input type="text" size="10" id="deadline" name="deadline" />
			...
			<div class="col-lg-4">
				...
				<div class="widget">
					...
					<ul class="cat">
						<li><i class="icon-angle-right"></i><a href="#">웹마스터·QA·테스터</a><span> (20)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">서버·네트워크·보안</a><span> (11)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">웹기획·웹마케팅·PM</a><span> (9)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">웹프로그래머</a><span> (12)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">컨텐츠·사이트운영</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">응용프로그래머</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">시스템프로그래머</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">ERP·시스템분석·설계</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">통신·모바일</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">HW·SW</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">웹디자인</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">HTML·웹표준·UI개발</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">동영상·편집·코덱</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">IT·디자인·컴퓨터교육</a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">데이터베이스   </a><span> (18)</span></li>
						<li><i class="icon-angle-right"></i><a href="#">게임</a><span> (18)</span></li>
					</ul>
				</div>
				<div class="widget">
