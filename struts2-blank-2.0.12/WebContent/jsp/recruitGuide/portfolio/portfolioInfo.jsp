		...
		<div class="row">
			...
			<legend>PORTFOLIO</legend>
				<table width="" height="" class="tbl_type" cellspacing = "0">
					<tbody>
						<tr>
							<td rowspan = "5" width = "620"><img src = "/img/portfolioUp/${bean.imgFileName}" width = "600"/></td>
							<td height = "15"> ${bean.mem_id}</td>
						</tr>
						<tr>
							<td class = "td_title" height = "30"> ${bean.por_title}</td>
						</tr>
						<tr>
				...
				<div class="cmt_comm">
					...
					<form action="/portfolio/portfolioReplyInsert.action?por_no=${bean.por_no}&job=info" name="replyForm" id="replyForm" method="post">
						<fieldset class="fld_cmt" style="width: 800px;">
							...
							<input type="hidden" name="rep_infono" value="${bean.por_no}" /> 
			...
			<div class="col-lg-4">
					...
					<div class="widget">
						<h4 class="widgetheading">취업가이드</h4>
							<ul class="cat">
								<li><i class="icon-angle-right"></i><a href="/jsp/community/board/boardList.jsp">취업후기</a><span id="j1"></span></li>
								<li><i class="icon-angle-right"></i><a href="/jsp/community/board/boardList.jsp">자기소개서</a><span id="j1"></span></li>
								<li><i class="icon-angle-right"></i><a href="/jsp/community/board/boardList.jsp">포트폴리오</a><span id="j1"></span></li>
								<li><i class="icon-angle-right"></i><a href="/jsp/community/board/boardList.jsp">직무분석</a><span id="j1"></span></li>
