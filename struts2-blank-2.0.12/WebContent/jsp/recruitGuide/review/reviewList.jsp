...
<tr>
<td>${cnt.count}</td>
<td class="title"><a href="/review/hit.action?rev_no=${i.rev_no}&job=info">${i.rev_title}</a></td>
<td>${i.mem_id}</td>
<td>${i.rev_hit}</td>
<td>${i.rev_date}</td>
</tr>
...
<div align="right">
		<a class="btn_big"
			href="/jsp/recruitGuide/review/reviewEdit.jsp"><span>글쓰기</span></a>
