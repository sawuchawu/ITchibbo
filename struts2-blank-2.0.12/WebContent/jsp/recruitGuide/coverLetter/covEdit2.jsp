...
<body topmargin="40">
	<!-- UI Object -->
	<form action="/cov/covInsert.action" method="post" name="frm" id="frm" enctype="multipart/form-data">
		<fieldset>
			<legend>합격자소서 글쓰기</legend>
				...
				<table border="1" cellspacing="0" summary="표의 요약을 반드시 넣어 주세요">
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="item">
							<input title="레이블 텍스트" class="i_text" type="text" size="50" id="mem_id" name="mem_id" value="${id }" readonly="readonly">
							...
							<td>
								<div class="item">
									...
									<input title="레이블 텍스트" class="i_text" type="text" size="50" id="cov_com" name="cov_com">
								</div>
							</td>
						</tr>
						...
						<tr>
                           ...
                           <input type="text" value="" name="cov_job" id="cov_job">
								</div>
							</td>
						</tr>
						<tr>
                           ...
                           <input type="text" value="" name="cov_year" id="cov_year">
						...
						<tr>
							...
							<td>
								<div class="item">
									<input title="레이블 텍스트" class="i_text" type="text" size="50" id="cov_spec" name="cov_spec">
								</div>
							</td>
						</tr>
						...
						<tr>
                           ...
                           <input type="text" value="" name="cov_price" id="cov_price">
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="item">
									<input title="레이블 텍스트" class="i_text" type="text" size="50" id="cov_title" name="cov_title">
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="item">
									<input title="레이블 텍스트" class="i_text" type="text" size="50" id="cov_content" name="cov_content">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="item">
									<input title="레이블 텍스트" type="file" name="fileFileName" id="fileFileName">
								</div>
							</td>
						</tr>
					</tbody>
	...
	<div align="right">
		...
		<a class="btn_big" href="/cov/covList.action"><span>취소</span></a>
