...
function aaa(){
 	var a="";
	ckbox = document.getElementsByName("ck");
	...
	document.location.href='/jsp/myPage/cartList.jsp?a='+a+'&temp='+temp;
}
</script>
...
<%@ include file="/jsp/header.jsp" %>
 ...
 <jsp:include page="/jsp/myPage/protfolioScrapList.jsp"></jsp:include>  <br>
<jsp:include page="/jsp/myPage/covScrapList.jsp" ></jsp:include>
