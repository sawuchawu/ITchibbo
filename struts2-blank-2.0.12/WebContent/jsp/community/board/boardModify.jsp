				...
				<article>
						<div class="post-image">
							<div class="post-heading">
								...
								<!-- 컨텐츠 넣는 부분 -->
								<form action="/brd/brdModify.action" method="post" name="frm"
							...
							<div class="form_table">
								<table border="0" cellspacing="0" summary="표의 요약을 반드시 넣어 주세요">
									<tbody>
										<tr>
											<th scope="row">아이디</th>
											<td>admin <input type="hidden" value="${bean.brd_no}"
												id="brd_no" name="brd_no">
											</td>
										</tr>
										<%-- <tr>
											<th scope="row">작성일</th>
											...
											<td>
												<div class="item">
													<input title="레이블 텍스트" class="i_text" type="text" size="50"
														id="brd_title" name="brd_title" value="${bean.brd_title}">
										...
										<tr>
											...
											<td>
												<div class="item">
													<textarea rows="30" cols="150" id="brd_content"
														name="brd_content">${bean.brd_content }</textarea>
						...
						<div align="right">
							...
							<a class="btn_big" href="/brd/brdList.action"><span>취소</span></a>
