				...
				<article>
						<div class="post-image">
							<div class="post-heading">
								...
								<!-- 컨텐츠 넣는 부분 -->
								<form action="/brd/brdInsert.action" method="post" name="frm" id="frm" enctype="multipart/form-data">
						<fieldset>
							<h4>자유게시판</h4>
								...
								<table border="0" cellspacing="0" summary="표의 요약을 반드시 넣어 주세요">
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="item">
													<textarea title="레이블 텍스트" class="i_text" rows="20"
														name="brd_content" id="brd_content"></textarea>
												</div>
											</td>
										</tr>
