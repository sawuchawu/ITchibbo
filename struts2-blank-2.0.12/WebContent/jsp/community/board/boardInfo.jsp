				...
				<article>
						<div class="post-image">
							...
							<br>
										...
										<table border="0" cellspacing="0" summary="표의 요약을 반드시 넣어 주세요">
											<tbody>
												<tr>
													...
													<div class="item">
														<td><input type="hidden" value="${bean.brd_no}"
															id="brd_no" name="brd_no"> <input type="hidden"
															value="${bean.brd_hit}" id="brd_hit" name="brd_hit">
														</td>
													</div>
													<td></td>
													<td></td>
												...
												<tr>
													<th scope="row">작성일</th>
													<td colspan="2">${bean.brd_date}</td>
													<div class="item">
														<td></td>
													</div>
													<th scope="row">조회수</th>
													<td colspan="2">${bean.brd_hit}</td>
													<div class="item">
														<td></td>
													</div>
												</tr>
												...
												<tr>
													<th scope="row">제목</th>
													<td colspan="4">${bean.brd_title}</td>
													<div class="item">
														<td></td>
													</div>
													<td></td>
												...
												<tr>
													<th scope="row">내용</th>
													<td colspan="4">${bean.brd_content}</td>
													<div class="item">
														<td></td>
													</div>
													<td></td>
								...
								<div align="right">
									<a class="btn_big"
										href="/brd/brdInfo.action?brd_no=${bean.brd_no}&jobs=modify"><strong>수정</strong></a>
									<a class="btn_big"
										href="/brd/brdDelete.action?brd_no=${bean.brd_no}"><strong>삭제</strong></a>
									<a class="btn_big" href="/brd/brdList.action"><span>목록</span></a>
						...
						<form
							action="/brd/brdreplyInsert.action?brd_no=${bean.brd_no}&jobs=info"
							...
							<fieldset class="fld_cmt" style="width: 800px;">
								<strong class="screen_out">댓글 달기</strong><br> <input
									...
									type="hidden" name="rep_infono" value="${bean.brd_no}" /> <input
						...
						<c:forEach var="i" items="${list}">
							<div class="list_cmt" style="width: 800px;">
								...
								<div class="cmt_foot"> 
									...
									<a
											href="/brd/brdReplyDelete.action?brd_no=${i.rep_infono}&rep_no=${i.rep_no}&jobs=info">삭제</a><span class="txt_bar">
								</div>
