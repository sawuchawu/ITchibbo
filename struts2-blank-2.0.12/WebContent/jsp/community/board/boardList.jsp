...
<h4>자유게시판</h4>
								...
								<tbody>
									<c:forEach var="i" items="${list}" varStatus="cnt">
										<tr>
											...
											<td>${cnt.count}</td>
											<td class="title"><a
												href="/brd/hit.action?brd_no=${i.brd_no}&jobs=info">&nbsp;&nbsp;&nbsp;&nbsp;${i.brd_title}</a></td>
											<td>${i.mem_id}<input type="hidden" value="${i.brd_no}"
												id="brd_no" name="brd_no"></td>
											<td>${i.brd_date}</td>
											<td>${i.brd_hit}</td>
											<%-- <td>${i.qna_date}</td> --%>
						...
						<div align="right">
							<a class="btn_big" href="/jsp/community/board/boardEdit.jsp"><span>글쓰기</span></a>
						</div>
					</div>
