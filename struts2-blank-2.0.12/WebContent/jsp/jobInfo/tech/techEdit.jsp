				...
				<article>
						<div class="post-image">
							<div class="post-heading">
								...
								<!-- 컨텐츠 넣는 부분 -->
								<form action="/tech/techInsert.action" method="post" name="frm" id="frm" enctype="multipart/form-data">
					<fieldset>
						<legend>TECH</legend>
						...
						<td>
							<div class="item">
								<input title="레이블 텍스트" class="i_text" type="text" name = "tec_title" id = "tec_title">
							</div>
						</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="item">
									<textarea title="레이블 텍스트" class="i_text" rows="5" cols="50" name="tec_content" id="tec_content"></textarea>
								</div>
							</td>
						<tr>
							<th scope="row">파일</th>
					...
					href="/tech/techList.action"><span>취소</span></a>
