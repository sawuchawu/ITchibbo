...
${bean }
	<!-- UI Object -->
	<form action="/expo/dataModify.action" method="post" name="frm" id="frm" enctype="multipart/form-data">
		<fieldset>
				...
				<table border="1" cellspacing="0" summary="표의 요약을 반드시 넣어 주세요">
					<tbody>
						...
						<tr>
							<th scope="row">ID</th>
							<td>
								<div class="item">${bean.mem_id }</div>
							</td>
						</tr>
						<tr>
							<th scope="row">제목</th>
							<td>
								<div class="item">
								<input type="hidden" value="${bean.exp_no }" id="exp_no" name="exp_no">
									<input value="${bean.exp_title }" title="레이블 텍스트" class="i_text" type="text" size="50" id="exp_title" name="exp_title">
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="item">
									...
									<input type="text" value="${bean.exp_date }" name="exp_date" id="exp_date">
								</div>
							</td>
						</tr>
						<tr>
