			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="post-image">
								...
								<tbody>
									<c:forEach var="i" items="${list}" varStatus="cnt">
										<tr>
											<td>${cnt.count}</td>
											<td class="title">
											<a href="/jasoseol/jasoseolInfo.action?com_no=${i.com_no}&job=info&currentPage=${currentPage}">
																&nbsp;&nbsp;&nbsp;&nbsp;${i.com_name.split("_")[0]}</a>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div align="right">
							<a class="btn_big" href="/jsp/jasoseol/jasoseolEdit.jsp"><span id="writeA">글쓰기</span></a>
						</div>
					</div>
